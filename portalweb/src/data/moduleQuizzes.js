...
function ph(modulo, quiz, title) {
  const topics = [
    ...
    ["el rol de la infraestructura en la seguridad vial", "No influye en los siniestros viales", "Puede diseñarse para minimizar la gravedad de los siniestros", "Solo importa en carreteras rurales", "Es responsabilidad exclusiva del usuario vial", "a"],
