  ...
  return (
    ...
    >
      <div className="space-y-5">
        ...
        <div className="flex items-center gap-2 rounded-full border border-[#1D4789]/30 bg-white h-12 px-4 cursor-not-allowed opacity-60 select-none">
          <MdLocationOn size={18} className="text-[#1D4789]/50 shrink-0" />
          <span className="flex-1 text-sm text-[#1a1a1a]">Antioquia</span>
          <MdLock size={14} className="text-[#1a1a1a]/30 shrink-0" />
        </div>
            ...
            <div
              className={`group flex items-center gap-2 rounded-full border h-12 px-2 transition-colors ${
                errors.documentType
                  ...
                  : "border-[#1D4789]/30 focus-within:border-[#1D4789] bg-white"
              }`}
            >
              <select
                ...
                className="peer min-w-0 bg-transparent text-[#1a1a1a] outline-none appearance-none cursor-pointer text-sm text-center"
                style={{
        ...
        <div className="flex gap-2">
          <label className="block w-auto">
            <div
              className="group flex items-center gap-2 rounded-full border h-12 px-2 transition-colors border-[#1D4789]/30 bg-white"
            >
              <select
                value="+57"
                disabled
                className="peer bg-transparent text-[#1a1a1a] outline-none appearance-none cursor-not-allowed text-sm text-center"
                style={{
                  width: "52px",
                  textAlignLast: "center",
                }}
      ...
      <button
        ...
        className="mt-7 mb-8 h-12 w-full rounded-full bg-[#1D4789] text-white font-medium shadow-[0_6px_18px_rgba(29,71,137,0.35)] transition hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#1D4789]/60 disabled:opacity-60"
      >
