...
export default function CertificateModal({ certConfig, onClose }) {
  ...
  const loadUser = useCallback(() => {
    ...
    setTipoDoc(normalizeDocType(u?.documentType));
    setStep("confirm");
  }, [session?.user]);
  ...
  return (
    ...
    >
      <div
        className="relative w-full rounded-2xl bg-[#0b1320] ring-1 ring-white/10 shadow-2xl overflow-hidden"
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-white/8">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <span
                className={`inline-flex text-[11px] font-medium px-2 py-0.5 rounded-full ring-1 ${badgeCls}`}
              >
                {badgeLabel}
              </span>
            </div>
              ...
              <div className="rounded-xl ring-1 ring-white/10 bg-white/4 divide-y divide-white/8">
                ...
                <div className="flex items-center justify-between px-4 py-3">
                  <div className="min-w-0">
                    ...
                    <p className="text-white text-[14px] font-medium truncate">
                      {nombre || (
                        <span className="text-white/25 italic">Sin nombre</span>
                      )}
                    </p>
                  </div>
                  <button
                ...
                <div className="px-4 py-3">
                  ...
                  <p className="text-white text-[14px] font-medium">
                    {displayDoc(tipoDoc)}{" "}
                    {numDoc || (
                      <span className="text-white/25 italic">Sin número</span>
                    )}
                  </p>
...
function Spinner() {
  return (
    <span className="h-8 w-8 rounded-full border-2 border-white/20 border-t-white/80 animate-spin inline-block" />
  );
}
